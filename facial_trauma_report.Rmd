...
Firstly, a patient's age has no influence on facial trauma sites, which means, people with different ages have the same possibility of getting hurt on different facial trauma sites. So we remove it from our model.
