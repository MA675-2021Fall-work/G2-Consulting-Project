...
```{r fig.cap="Prediction of probability of facial trauma sites in different injury mechanisms and different gender"}
...
tablsum[which(tablsum$Gender=="Male   "),2:6] %>%
  kable("pipe", caption = "Prediction of probability of facial trauma in Male")

tablsum[which(tablsum$Gender=="Female "),2:6] %>%
  kable("pipe", caption = "Prediction of probability of facial trauma in Female")

###### visualization of prediction ######
ggplot(melt(tablsum,id.vars=c("Gender","Urban.Rural","Injury.Mech.category")))+geom_point()+aes(x=variable,y=value,color=Urban.Rural,group=Urban.Rural)+facet_wrap(Gender~Injury.Mech.category)+coord_polar()+ geom_polygon(fill=NA)
...
+ Gender shows little influence on the possibility of getting hurt on different facial trauma sites.
